...
class CoolerMaintenanceReport(models.TransientModel):
    _name = 'cooler.maintenance.report.wizard'
    _description = 'Cooler Maintenance Report'
    ...
    def print_maintenance_report(self):
        ids = self._ids
        f_name = 'Cooler Maintenance Report' + '.xlsx'
        output = BytesIO()
        ...
        worksheet1.merge_range(0, 6, 0, 15, 'COOLER MAINTENANCE REPORT ', center_format)
        ...
        return {
            ...
            'view_type': 'form',
            'res_id': ids[0],
            'res_model': 'cooler.maintenance.report.wizard',
            'target': 'new',
            'name': 'Cooler Maintenance Report'
        }
